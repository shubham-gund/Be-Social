...
const ChatInterface: React.FC = () => {
  ...
  return (
    <div className="h-screen flex flex-col border-e border-gray-700">
      {/* Top Bar */}
      <div className="sticky top-0 z-10 flex items-center px-4 py-2 bg-neutral border-b border-gray-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-base-content">{isLoading ? "Typing..." : "Online"}</p>
          </div>
        </div>
      </div>
      ...
      {/* Input Area */}
      <div className="sticky bottom-0 w-full bg-base-100 p-4 border-t border-gray-700">
