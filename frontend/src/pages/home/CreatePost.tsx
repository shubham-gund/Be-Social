      ...
      <div className="fixed inset-0 flex justify-center items-center backdrop-blur-sm bg-black/50 z-50 p-4">
        <div className="bg-neutral w-full max-w-xl md:w-[600px] lg:w-[700px] rounded-lg shadow-lg p-6 md:p-4 relative max-h-[90vh] overflow-y-auto">
          ...
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            <textarea
              className="textarea flex-grow md:w-10/12 p-3 md:p-3 md:mx-11 text-base md:text-lg resize-none border border-gray-700 rounded-xl bg-base-200 placeholder-base-content focus:outline-none focus:ring-2 focus:ring-primary h-16 md:h-14"
