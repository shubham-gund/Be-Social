      ...
      <div className="flex-[4_4_0] border-r border-gray-700 min-h-screen ">
        ...
        <div className="flex flex-col">
          {!isLoading && !isRefetching && user && (
            <>
              <div className="flex gap-10 items-center p-4 border-b border-gray-700 sticky top-0 z-10 bg-base-100">
                <Link to="/">
              ...
              <div className="relative group/cover">
                <img
                  src={(coverImg as string) || user.coverImg || "/cover.png"}
                ...
                <div className="avatar absolute -bottom-16 left-4">
                  <div className="w-32 rounded-full relative group/avatar">
                    <img src={(profileImg as string) || user.profileImg || "/avatar-placeholder.png"} />
